\documentclass[solid,math,chem,code,notes,plot]{bmc}
...
% \colorlet{primaryVariant}{LightBlue}
...
\quad
\colorBox{alternativePrimary}\colorBox{primaryVariant}\colorBox{contrastColour}

\subsection{Other Defined Colours}

\colorBox{Grey} \quad \colorBox{LightGrey} \colorBox{DarkGrey} \\[-0.7mm]
\colorBox{Red} \quad \colorBox{LightRed} \colorBox{DarkRed} \\[-0.7mm]
\colorBox{Yellow} \quad \colorBox{LightYellow} \colorBox{DarkYellow} \\[-0.7mm]
\colorBox{Blue} \quad \colorBox{LightBlue} \colorBox{DarkBlue} \\[-0.7mm]
\colorBox{Green} \quad \colorBox{LightGreen} \colorBox{DarkGreen} \\[-0.7mm]
\colorBox{Orange} \quad \colorBox{LightOrange} \colorBox{DarkOrange} \\[-0.7mm]
\colorBox{Purple} \quad \colorBox{LightPurple} \colorBox{DarkPurple} \\[-0.7mm]
\colorBox{Cyan} \quad \colorBox{LightCyan} \colorBox{DarkCyan}
